...
BOT_TOKEN = environ.get('BOT_TOKEN', '7537691731:AAFYpVB7qqEvv0I1s_sJryNfgwkFdllzoFg')
...
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://sandhubot00:Shandhu@cluster0.ipni4.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
REF_PREMIUM = 30
PREMIUM_POINT = 1500
auth_channel = environ.get('AUTH_CHANNEL', '-1002116325676')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
SUPPORT_GROUP = int(environ.get('SUPPORT_GROUP', 'Sandhu_7418'))
